            ...
            { "data": "capacidad", "width": "20%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                        <a href="/Ubicacion/UpInsert?id=${data}" class='btn btn-success text-white' style='cursor:pointer; width:70px;'>
                            Editar
                        </a>
                        &nbsp;
                        <a class='btn btn-danger text-white' style='cursor:pointer; width:80px;'
                            onclick=Delete('/Ubicacion/Delete?id='+${data})>
                            Eliminar
                        </a>
                        </div>`;
                }, "width": "15%"
